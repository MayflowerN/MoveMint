...
//                        debugPrint("Failed to set display name: \(error.localizedDescription)")
//                        return
//                    }
...
//            "name": self.name
//        ]
//        K.USER_COLLECTION.document(uid).setData(data) { error in
//            if let error = error {
//                debugPrint("Failed to save user data to firestore with error: \(error.localizedDescription)")
//                return
//            }
//            debugPrint("User added for firestore successfully")
//        }
//    }
//
//    
